...
export const THRUST = -0.56;
export const TERMINAL_VELOCITY_DOWN = 8;
export const TERMINAL_VELOCITY_UP = -4.5;
...
export const PLAYER_THRUST_RAMP_UP = 0.12;
export const PLAYER_THRUST_RAMP_DOWN = 0.08;
export const FLAME_THRESHOLD = 0.18;
export const PLAYER_LIVES_MAX = 3;
export const PLAYER_HIT_FLASH_MS = 220;
export const PLAYER_RESPAWN_INVULNERABLE_MS = 1050;
export const PLAYER_RESPAWN_BANNER_MS = 950;
export const PLAYER_RESPAWN_ZAPPER_GAP = 520;
export const FIRST_RUN_HINT_DELAY_MS = 2000;
export const VISION_SAMPLE_MS = 33;
export const ZAPPER_FIRST_SPAWN_DISTANCE = 760;
export const OBSTACLE_DIFFICULTY_RAMP_DISTANCE = 4200;
export const ZAPPER_MIN_SPACING_EASY = 640;
export const ZAPPER_MAX_SPACING_EASY = 900;
export const ZAPPER_MIN_SPACING_HARD = 440;
export const ZAPPER_MAX_SPACING_HARD = 680;
...
export const ZAPPER_MIN_CENTER_Y = 130;
export const ZAPPER_MAX_CENTER_Y = 430;
export const ZAPPER_LANE_TOP = 190;
export const ZAPPER_LANE_MID = 300;
export const ZAPPER_LANE_LOW = 410;
export const ZAPPER_GATE_TOP = 170;
export const ZAPPER_GATE_BOTTOM = 430;
export const ZAPPER_GATE_SAFE_Y = 300;
export const INGREDIENT_RADIUS = 12;
export const INGREDIENT_PATTERN_SPACING = 34;
export const INGREDIENT_ZIGZAG_STEP = 18;
export const INGREDIENT_ARC_HEIGHT = 30;
export const INGREDIENT_PATTERN_COUNT = 5;
export const INGREDIENT_PATTERN_GRID_ROWS = 2;
export const INGREDIENT_PATTERN_GRID_COLS = 3;
export const INGREDIENT_AVOIDANCE_Y = 120;
export const INGREDIENT_LANE_OFFSET = 170;
export const INGREDIENT_MIN_Y = CEILING_Y + 110;
export const INGREDIENT_MAX_Y = GROUND_Y - 150;
export const INGREDIENT_PICKUP_PAD = 12;
...
export const HUD_CAPSULE_W = 180;
export const HUD_CAPSULE_H = 40;
