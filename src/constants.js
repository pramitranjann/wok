...
export const THRUST = -0.66;
export const TERMINAL_VELOCITY_DOWN = 8;
export const TERMINAL_VELOCITY_UP = -5.2;
...
export const PLAYER_THRUST_RAMP_UP = 0.11;
export const PLAYER_THRUST_RAMP_DOWN = 0.09;
...
export const HUD_BURNER_W = 272;
export const HUD_BURNER_H = 68;
